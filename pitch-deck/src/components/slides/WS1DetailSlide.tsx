...
export function WS1DetailSlide() {
  return (
    <div className="grid h-full gap-8 pt-16 md:grid-cols-[0.8fr_1.2fr] md:items-center">
      <div>
        <p className="mb-4 text-sm font-medium text-join-orange">Strategy</p>
        ...
        <ul className="space-y-2 text-lg leading-7 text-ink/70">
          <li className="flex items-start gap-2"><ArrowRight size={18} className="mt-1 shrink-0 text-join-orange" /> Establish each GTL as credible and investable.</li>
          <li className="flex items-start gap-2"><ArrowRight size={18} className="mt-1 shrink-0 text-join-orange" /> Position the foundation as the network powering long-term impact.</li>
          <li className="flex items-start gap-2"><ArrowRight size={18} className="mt-1 shrink-0 text-join-orange" /> Create a high-visibility, shareable global moment.</li>
          <li className="flex items-start gap-2"><ArrowRight size={18} className="mt-1 shrink-0 text-join-orange" /> Translate inspiration into media and philanthropic engagement.</li>
        </ul>
      </div>
      <div className="space-y-3">
        {deliverables.map(([title, copy], index) => (
          <article
            ...
            className="deep-step grid gap-4 border-t border-ink/10 py-4 md:grid-cols-[4rem_1fr]"
