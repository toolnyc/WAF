...
export const slideRegistry: DeckSlide[] = [
  ...
  { id: "arc", label: "Campaign Arc Overview", kicker: "June–September", scrollWeight: 1, accent: "#004FA6", theme: "light", component: ArcOverviewSlide },
  { id: "ws1-title", label: "2026 GTL Launch", kicker: "Workstream 1", scrollWeight: 1, accent: "#FF8208", theme: "color", component: WS1TitleSlide },
  { id: "ws1-detail", label: "GTL Launch Strategy", kicker: "Workstream 1", scrollWeight: 5, accent: "#FF8208", theme: "light", component: WS1DetailSlide },
  { id: "ws2-title", label: "Pre-Summit Social", kicker: "Workstream 2", scrollWeight: 1, accent: "#3BB54A", theme: "color", component: WS2TitleSlide },
  { id: "ws2-detail", label: "Content Formats", kicker: "Workstream 2", scrollWeight: 4, accent: "#3BB54A", theme: "light", component: WS2DetailSlide },
  { id: "ws3-title", label: "Abbey Road Video", kicker: "Workstream 3", scrollWeight: 1, accent: "#004FA6", theme: "dark", component: WS3TitleSlide },
  { id: "ws3-vision", label: "Creative Vision", kicker: "Workstream 3", scrollWeight: 1, accent: "#004FA6", theme: "dark", component: WS3PlaceholderSlide },
  { id: "process", label: "Process", kicker: "How We Work", scrollWeight: 2, accent: "#F2C740", theme: "light", component: ProcessSlide },
  { id: "timeline", label: "Timeline", kicker: "Pacing", scrollWeight: 1, accent: "#004FA6", theme: "light", component: TimelineSlide },
  { id: "budget", label: "Budget", kicker: "Investment", scrollWeight: 1, accent: "#FF8208", theme: "light", component: BudgetSlide },
  { id: "close", label: "WE ARE FAMILY.", kicker: "Close", scrollWeight: 1, accent: "#CCFF66", theme: "dark", component: CloseSlide },
];
